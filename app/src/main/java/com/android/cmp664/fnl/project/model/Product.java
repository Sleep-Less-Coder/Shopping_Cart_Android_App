package com.android.cmp664.fnl.project.model;

import java.io.Serializable;
import java.math.BigDecimal;

import com.android.cmp664.fnl.model.Saleable;
...
public class Product implements Saleable, Serializable {
    ...
    public Product(int pId, String pName, BigDecimal pPrice, String pDescription, String pImageName, String pLargeImage) {
        setId(pId);
        setName(pName);
        setPrice(pPrice);
        setDescription(pDescription);
        setImageName(pImageName);
        setLargeImageName(pLargeImage);
    }
    ...
    public String getLargeImageName() { return pLargeImage; }

    public void setLargeImageName(String largeImageName) {
        this.pLargeImage = largeImageName;
    }
}
